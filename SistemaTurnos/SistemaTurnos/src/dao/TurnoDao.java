...
public class TurnoDao extends Dao<Turno> {
	...
	// Consulta 1: Traer Turnos por Fecha y Cupo Máximo
	...
	// Método para traer turnos por servicio
	public List<Turno> traerPorServicio(Servicio servicio) throws HibernateException {
		List<Turno> turnos = null;
		try {
			iniciaOperacion();
			// Consulta HQL para obtener todos los turnos de un servicio específico
